          ...
          <footer className="dark:bg-gray-900 dark:text-white">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm dark:bg-gray-900 dark:text-white sm:text-center dark:text-white-400">
                  © {currentYear}{" "}
                  <a
                    href="https://flowbite.com/"
                    className="hover:underline"
                ...
                <div className="flex mt-4 sm:justify-center sm:mt-0">
                  {[
                    ...
                    <a
                      key={index}
                      href={social.href}
                      className="text-gray-900 hover:text-gray-500 dark:bg-gray-900 dark:text-white ms-5"
                    >
                      <svg
                        className="w-4 h-4"
                        aria-hidden="true"
