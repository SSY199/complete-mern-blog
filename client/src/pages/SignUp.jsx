        ...
        <div className="flex-1 text-center md:text-left">
          <Link to={"/"}>
            <h1 className="font-bold dark:text-white text-4xl">
              <span className="px-2 py-1 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 rounded-lg text-black">
                DEV
              </span>
              NINJAS
            </h1>
          ...
          <p className="mt-4 text-lg dark:text-white animate-typing">
            Welcome to Dev-Ninjas, a platform where developers share their
            knowledge, experiences, and projects. Join our community to stay
            updated with the latest trends in technology, collaborate on
            exciting projects, and enhance your skills.
          </p>
        </div>
        {/* right */}
        <div className="flex-1">
          <form
            className="flex flex-col gap-4 bg-purple-600 dark:bg-[rgb(16,23,42)] p-4 rounded-lg"
